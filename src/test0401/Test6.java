...
(3) public final double methoda(); -> final 메서드는 오버라이딩 불가
(4) static void methoda(double d1); - > 구현부 없이 사용불가
(5) protected void methoda(double d1); ->protected 불가
...
5. 다음 A 인터페이스를 상속 받아서 새로운 B 인터페이스를 생성하고         (1)
